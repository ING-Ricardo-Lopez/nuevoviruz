...
function expectIndexedColor(color: unknown) {
...
test("returns syntax styles and indexed splash colors", async () => {
  ...
  try {
    ...
    expectIndexedColor(theme.splash.left)
    expectIndexedColor(theme.splash.right)
    expectIndexedColor(theme.splash.leftShadow)
    expectIndexedColor(theme.splash.rightShadow)
