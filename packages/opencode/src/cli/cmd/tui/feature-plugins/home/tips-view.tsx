...
const TIPS = [
  ...
  "NuevoViruz auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "NuevoViruz auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "NuevoViruz uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent NuevoViruz from reading sensitive files",
  "Use {highlight}nuevoviruz run{/highlight} for non-interactive scripting",
  "Use {highlight}nuevoviruz --continue{/highlight} to resume the last session",
  "Use {highlight}nuevoviruz run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}nuevoviruz serve{/highlight} for headless API access to NuevoViruz",
  "Use {highlight}nuevoviruz run --attach{/highlight} to connect to a running server",
  "Run {highlight}nuevoviruz upgrade{/highlight} to update to the latest version",
  "Run {highlight}nuevoviruz auth list{/highlight} to see all configured providers",
  "Run {highlight}nuevoviruz agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}nuevoviruz debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/ing-ricardo-lopez/nuevoviruz{/highlight} for containerized use",
